...
**Phase:** Week 3 in progress — Prompt 7 (Norway/UK/US country packs, `22daf79`) shipped. Week 2 complete: Prompt 5 (bulk add + Stakeholders, `c40b61f`) + Prompt 6 (Denmark pack, `96e0b85`). Scaffold (Prompt 1) + full schema (Prompts 2/4) + magic-link auth (Prompt 3) + cap-table view (Prompt 4) complete. **Prompt 8 (basic Simulator) is next.**
